...
class __TwigTemplate_bcc00bb3db3e7dbf47e40166ef8de24d134cbe26b0d63691ae8341d135cc2ab0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  64 => 6,  60 => 5,  56 => 4,  50 => 3,  46 => 2,  43 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<div class=\"product-item\">
    <a href=\"{{ path('product', {'slug' : product.slug}) }}\"><img
                src=\"{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid\"></a>
    <h5 class=\"product-name\">{{ product.name }}</h5>
    <span class=\"product-subtitle\">{{ product.subtitle }}</span>
    <span class=\"product-price\">{{ (product.price / 100)|number_format(2, ',', '.') }} €</span>
</div>
", "product/single_product.html.twig", "C:\\Users\\oumayma\\PhpstormProjects\\blogsymfony\\ma-boutique\\templates\\product\\single_product.html.twig");
    }
}
