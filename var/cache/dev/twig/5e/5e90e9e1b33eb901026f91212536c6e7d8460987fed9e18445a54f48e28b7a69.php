...
class __TwigTemplate_d4fc2d0c5b18c43e90da4a9c9e4487fe54b9544e5f3ccd4369eabea0dddc0c80 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Confirmation de ma commande - Ma Boutique";
    ...
    <p>
        ...
        echo "</strong> <br />
        Une confirmation vient de vous être envoyé par email à l'adresse <strong>";
        // line 10
    ...
    ";
        ...
        echo "
    <hr>
    Pour suivre votre commande, rendez-vous sur votre <a href=\"";
        // line 15
...
{% block title %}Confirmation de ma commande - Ma Boutique{% endblock %}

{% block content %}
    <h2>Confirmation de commande</h2>
    <p>
        Bonjour <strong>{{ order.user.firstname }} {{ order.user.lastname }}.</strong> <br />
        Nous vous remercions pour votre commande  n° <strong>{{ order.reference }}</strong> <br />
        Une confirmation vient de vous être envoyé par email à l'adresse <strong>{{ order.user.email }}</strong>
    <hr>
    Votre commande sera livrée par <strong>{{ order.carrierName }}</strong> à l'adresse suivante <br />
    {{ order.delivery|raw }}
    <hr>
    Pour suivre votre commande, rendez-vous sur votre <a href=\"{{ path('account_order') }}\">compte</a>
    </p>
{% endblock %}
", "order_validate/index.html.twig", "C:\\Users\\oumayma\\PhpstormProjects\\boutique\\templates\\order_validate\\index.html.twig");
    }
}
