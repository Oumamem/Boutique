...
class __TwigTemplate_5f506d2decbbc581cbbf364278ec44f4ce4aa902f2e1bfe1766ed018550a3f2d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_ADMIN")) {
            // line 8
            echo "        <small><a href=\"/admin\">- Vous êtes administrateur : accéder au backoffice</a></small><br/>
    ";
        }
        // line 10
        echo "    <p>Bienvenue ";
        ...
        C'est dans cet espace que vous allez pouvoir gérer toutes vos informations personnelles.</p>
    <hr>
    <div class=\"row\">
        <div class=\"col-md-4\">
...
";
    ...
    {
        return array (  123 => 26,  115 => 21,  107 => 16,  97 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mon compte - Ma Boutique{% endblock %}

{% block content %}
    <h1>Mon compte</h1>
    {% if is_granted('ROLE_ADMIN') %}
        <small><a href=\"/admin\">- Vous êtes administrateur : accéder au backoffice</a></small><br/>
    {% endif %}
    <p>Bienvenue {{ app.user.firstname }} dans votre compte. <br>
        C'est dans cet espace que vous allez pouvoir gérer toutes vos informations personnelles.</p>
    <hr>
    <div class=\"row\">
        <div class=\"col-md-4\">
        ...
        <div class=\"col-md-4\">
            <div class=\"account-item text-center\">
                <a href=\"{{ path('account_order') }}\">Afficher mes commandes</a>
            </div>
        </div>
    </div>
...
{% endblock %}
", "account/index.html.twig", "C:\\Users\\oumayma\\PhpstormProjects\\blogsymfony\\ma-boutique\\templates\\account\\index.html.twig");
    }
}
