 ...
 */
class getAproposRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AproposRepository' shared autowired service.
     *
     * @return \App\Repository\AproposRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AproposRepository.php';

        return $container->privates['App\\Repository\\AproposRepository'] = new \App\Repository\AproposRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
